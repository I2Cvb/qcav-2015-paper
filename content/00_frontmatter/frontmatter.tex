...
\author{Guillaume~Lema\^{i}tre\supit{a,b} and
                Joan~Massich\supit{a} and
                Robert~Mart\'{i}\supit{b} and
                Jordi~Freixenet\supit{b} and
                Joan~C.~Vilanova\supit{c} and
                Paul~M.~Walker\supit{d} and
  ...
  \supit{c}{\small Department of Magnetic Resonance, Clinica Girona, Lorenzana 36, 17002 Girona, Spain} \\
  \supit{d}{\small LE2I-UMR CNRS 6306, Universit\'{e} de Bourgogne, Avenue Alain Savary, 21000 Dijon, France;} \\
}
