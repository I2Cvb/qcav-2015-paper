...
\input{content/00_frontmatter/frontmatter.tex}             % contains the Title and Autor info
...
\input{content/01_introduction/introduction}   % the file wihtout .tex
\input{content/02_methodology/methodology}
\input{content/03_results/results}
%\input{content/04_discussion/discussion}
\input{content/05_conclusion/conclusion}
...
\input{content/06_authorship/authorship}
